...
ENGINE_SRC  = common/debug.c engine/core.c engine/event.c engine/render/render.c engine/render/rle.c engine/render/3d.c platform/filesys.c platform/mpool.c common/math3d.c
